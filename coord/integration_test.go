...
func TestIntegration_LinkAndReady_RoundTrip(t *testing.T) {
	...
	blocker := linkTestSeed(t, c, "bones-it11", "blocker")
	blocked := linkTestSeed(t, c, "bones-it22", "blocked")
	winner := linkTestSeed(t, c, "bones-it33", "winner")
	loser := linkTestSeed(t, c, "bones-it44", "loser")
	canonical := linkTestSeed(t, c, "bones-it55", "canonical")
	dup := linkTestSeed(t, c, "bones-it66", "dup")
	discovery := linkTestSeed(t, c, "bones-it77", "discovery")
	seed := linkTestSeed(t, c, "bones-it88", "seed")
	parent := linkTestSeed(t, c, "bones-it99", "parent")
	child := seedChild(t, c, "bones-itaa", "child", parent)
