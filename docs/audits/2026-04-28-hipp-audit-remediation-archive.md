...
| 3     | `bones hub start` / `bones hub stop` Go commands               | Done   | `internal/hub/hub.go` exists; `cli/templates/orchestrator/scripts/hub-bootstrap.sh` reduced to a shim around `bones hub start`. ADR 0023 records the design. |
